...
type IncomingOrder = {
  ...
  postalCode?: string;
  country?: string;
  items: OrderItem[]; // required in your schema
  notes?: string;
};
...
export async function POST(req: Request) {
  try {
    ...
    // --- minimal validation (matches your table constraints) ---
    ...
    // 1) Save order to Supabase (column names match your schema)
    ...
    // 2) Send confirmation email to customer + you
